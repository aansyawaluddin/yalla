...
class ProfileScreenTravel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                      ...
                      children: [
                        ...
                        _buildMenuListItem(
                          ...
                          onTap: () {
                            _navigateTo(
                              context,
                              const PaymentMethodScreenTravel(),
                            );
                          },
                        ),
                        const Divider(
                        ...
                        _buildMenuListItem(
                          icon: Icons.groups,
                          iconColor: const Color(0xFFC700D8),
                        ...
                        _buildMenuListItem(
                          ...
                          title: "Pengaturan",
                          onTap: () {
                            _navigateTo(context, const SettingsScreenTravel());
                          },
                        ),
                        const Divider(
                          height: 1,
      ...
      bottomNavigationBar: const TravelCustomBottomNavBar(currentIndex: 4),
    );
  }
