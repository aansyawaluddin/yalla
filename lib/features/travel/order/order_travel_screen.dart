...
import 'package:yalla/core/widgets/card/order/order_flight_travel_card.dart';

class OrderTravelScreen extends StatefulWidget {
  const OrderTravelScreen({super.key});

  @override
  State<OrderTravelScreen> createState() => _OrderTravelScreenState();
}

class _OrderTravelScreenState extends State<OrderTravelScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                  ...
                  child: isLoading
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return OrderFlightTravelCard(order: orderData);
                          },
                        ),
                ),
              ],
      ...
      bottomNavigationBar: const TravelCustomBottomNavBar(currentIndex: 3),
    );
  }
